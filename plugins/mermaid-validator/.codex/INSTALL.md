...
ln -s ~/.codex/shdennlin-agent-plugins/plugins/mermaid-validator/skills ~/.agents/skills/mermaid-validator
```
...
cmd /c mklink /J "$env:USERPROFILE\.agents\skills\mermaid-validator" "$env:USERPROFILE\.codex\shdennlin-agent-plugins\plugins\mermaid-validator\skills"
```
...
```powershell
cmd /c rmdir "$env:USERPROFILE\.agents\skills\mermaid-validator"
